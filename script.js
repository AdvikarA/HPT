  ...
  const questionData = [
    ...
    },
    {
      ...
      questions: [
        ...
        { text: "25. Eaten in the Square because HUDS closed too early?", info: "Breakfast: 7:30–10:30am · Lunch: 11:30am–2:00pm · Dinner: 4:30pm–7:30pm. Skip a meal and accidentally fast for 16 hours." },
    ...
    },
    {
      ...
      questions: [
        ...
        { text: "41. Seen a wild turkey?", info: "Harvard’s unofficial mascot" },
        { text: "42. Picked up a wild turkey?", info: "Bonus points if you still have 10 fingers" },
        { text: "43. Pet Remy?", info: "Remy the campus cat: one of Harvard’s biggest purr-sonalities" },
        { text: "44. Pet Sasha?", info: "A black labrodor retriever police dog" },
        { text: "45. Ridden a scooter through the Yard?", info: "The Yard: the heart of Harvard’s campus." },
        { text: "46. Been hit by a scooter?" },
        { text: "47. Taken the T?", info: "Boston’s subway system. Famous for its loud screeches, delays, and unruly passengers." },
        { text: "48. Talked to a homeless person in Harvard Square?" },
        { text: "49. Met a student whose last name is on a building?", info: "I wonder how they got in…" },
        { text: "50. Gone a month without leaving the Harvard Bubble?", info: "The Harvard Bubble: the imaginary boundary that traps Harvard students on campus" }
      ]
    },
    {
      category: "SCHOOL SPIRIT",
      questions: [
        { text: "57. Intentionally worn Harvard merch to Logan?", info: "Boston Logan International Airport — an impromptu networking hub" },
        { text: "58. Attended Harvard-Yale?", info: "Harvard-Yale: the only football game a year most students attend" },
        { text: "59. Tailgated Harvard-Yale?", info: "The most fun Harvard students have all year" },
        { text: "60. Missed Harvard-Yale after tailgating too hard?", info: "Students go all out for a once-a-year tradition" },
        { text: "61. Attended a varsity sports game besides Harvard-Yale?", info: "Low school spirit is an understatement" },
        { text: "62. Said “small liberal arts school just outside of Boston”?", info: "Actually saying ‘Harvard’ feels a little too cringe" },
        { text: "63. Dropped the “H-bomb” for clout?", info: "Instant aura." },
        { text: "64. Been posted on the Khuranagram?", info: "Students’ favorite dean, Rakesh Khurana, may spend more time posting than administrating." },
        { text: "65. Been in a housing day video?", info: "Hype music videos published by all 12 upperclassmen houses the week leading up to housing day" },
        { text: "66. Attended Head of the Charles?", info: "400,000 spectators visit campus every year to watch rowing — the one sport Harvard’s good at" },
        { text: "67. Swam in the Charles?", info: "The Charles River: full of rowers in the summer and ice in the winter" }
      ]
    },
    {
      category: "SOCIAL LIFE",
      questions: [
        { text: "68. Attended Quinski?", info: "Ski-themed party hosted by Quinski House, an upperclassman residence" },
        { text: "69. Attended Glowell?", info: "Glow-stick-themed party hosted by Lowell House, an upperclassman residence" },
        { text: "70. Attended Mather Lather?", info: "Foam-themed party hosted by Mather House, an upperclassman residence" },
        { text: "71. Attended Crimween or Crim Patty’s?", info: "Two holiday parties hosted by The Harvard Crimson" },
        { text: "72. Attended Crimson Jam or Yardfest?", info: "Blacking out’s the only way to enjoy the show" },
        { text: "73. Attended a frat party at another Boston-area school?", info: "MIT and BU are Harvard-student favorites" },
        { text: "74. Attended a final club party?", info: "Better be on the list…" },
        { text: "75. Gotten punched for a final club?", info: "Punching: the secretive, invite-only, four-round process that final clubs use to select sophomores" },
        { text: "76. Been inside all 8 final clubs?", info: "Porcellian, A.D., Delphic, Fly, Phoenix S.K., Owl, Fox, Spee" }
      ]
    },
    {
      category: "INTIMACY",
      questions: [
        { text: "77. Gone on a dhall date?" },
        ...
        { text: "89. Walk of shame to / from the Quad?", info: "The Yard: home to freshman residence halls" },
    ...
    },
    {
      ...
      questions: [
        { text: "94. River run?", info: "The night before housing day, freshmen take a shot in each of the 9 river houses to appease the river gods’ decision. For extra luck, students take additional shots in desired houses. Housing day: when freshmen find out their lottery-assigned houses for the next three years. River Houses: the 9 upperclassmen houses along the Charles River. Highly desirable due to location." },
        { text: "95. Primal scream?", info: "The night before final exams, students strip naked and run a lap around Harvard Yard. Harvard Yard: the heart of campus." },
...
function createTooltip(infoIcon, text) {
    ...
    infoIcon.addEventListener('mouseenter', () => {
        ...
        // Vertically center the tooltip with the icon
        const tooltipHeight = tooltip.offsetHeight;
        tooltip.style.top = `${iconRect.top + (iconRect.height / 2) - (tooltipHeight / 2)}px`;
        
        // Check if tooltip goes off screen to the right
        const tooltipRect = tooltip.getBoundingClientRect();
        if (tooltipRect.right > window.innerWidth) {
            // If it goes off screen, position it to the left of the icon instead
            tooltip.style.left = `${iconRect.left - tooltipRect.width - 10}px`;
            tooltip.style.setProperty('--arrow-direction', 'right');
        }
    });
...
// When creating question items:
function createQuestionItem(text, tooltipText, index) {
    const li = document.createElement('li');
    ...
    questionContainer.appendChild(infoIcon);
    questionContainer.appendChild(tooltip); // Keep tooltip inside container
